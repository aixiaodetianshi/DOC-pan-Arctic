...
output_bar_fig = os.path.join(output_dir, "mean_increase_rate_5class_De_histogram.tif")
...
yticks = [0, -2*1e-4, -4*1e-4]
yticklabels = [r'0', r'-2x$10^{-4}$', r'-4x$10^{-4}$']

ax.set_yticks(yticks)
ax.set_yticklabels(yticklabels, fontsize=6, fontname='Arial')

# 设置 x轴 位于 y=0  # English: set up
ax.spines['bottom'].set_position(('data', 0))  # x轴穿过 y=0  # English: The shaft passes through
ax.spines['bottom'].set_visible(True)  # 显示底部 spine  # English: Show bottom
