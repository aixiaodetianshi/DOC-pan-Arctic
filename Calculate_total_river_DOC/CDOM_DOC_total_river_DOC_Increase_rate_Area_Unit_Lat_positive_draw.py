...
output_path = r"D:\UZH\2024\20240122 Nutrient and Organic Carbon references\3_river_mouth_DOC\DOC_update_20250203\Total_DOC_increase_rate\Annual_increase_rate_DOC_Unit_In.tif"

# 读取数据  # English: Read data
df = pd.read_csv(file_path)
df['Annual_Increase_Rate_DOC_Area_Unit'] = df['Annual_Increase_Rate_DOC_Area_Unit']  # 单位为 Tg C/yr  # English: The unit is
...
ax.set_xlim(49, 83.5)
ax.set_ylabel('Increase rate (Tg C yr$^{-1}$ km$^{-2}$)', **font_kwargs)
