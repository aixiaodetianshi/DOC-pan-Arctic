...
# 5-10月占比  # English: Monthly proportion
...
file_path =                   r"D:\UZH\2024\20240122 Nutrient and Organic Carbon references\discharge\river_discharge\Yearly_Proportion_5_10\Total_discharge_Yearly_Mackenzie_Parts.xlsx"
output_path = r"D:\UZH\2024\20240122 Nutrient and Organic Carbon references\discharge\river_discharge\Yearly_Proportion_5_10\Total_discharge_Yearly_proportion_5_10_Mackenzie_Parts.tif"

# 读取数据  # English: Read data
data = pd.read_excel(file_path)

# 单位转换：100%  # English: Unit conversion
data['Proportion_5_10'] = data['Proportion_5_10'] * 100

# 提取数据  # English: Extract data
years = data['year']
Proportion_5_10 = data['Proportion_5_10']
...
# 绘制年度占比变化曲线  # English: Draw the annual share change curve
...
ax.set_ylabel('Proportion May-Oct.(%)', fontsize=6, fontname='Arial')
