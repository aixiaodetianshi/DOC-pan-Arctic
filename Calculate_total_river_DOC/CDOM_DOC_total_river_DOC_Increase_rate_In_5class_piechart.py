...
output_area_fig = os.path.join(output_dir, "area_5class_total_DOC_In_piechart.tif")

# 读取数据  # English: Read data
df = pd.read_csv(input_file)

df['Annual_Increase_Rate_1'] = df['Annual_Increase_Rate_1'] / 1e6 * 33  # 转换为 Tg C/yr, 33年 1984-2018  # English: Convert to
...
ax1.set_title("Increase Total DOC", fontsize=6, pad=-160)
