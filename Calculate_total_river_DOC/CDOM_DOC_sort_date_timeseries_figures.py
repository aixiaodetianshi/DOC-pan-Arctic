...
try:
    ...
    # 确保 date 列为 datetime 类型  # English: make sure
    # df['date'] = pd.to_datetime(df['date'])

    # 筛选出 2010 到 2015 年的数据  # English: Filter out
    ...
    # 设置时间轴格式  # English: Set the timeline format
    plt.gcf().autofmt_xdate()

    # 保存图表为 TIFF 格式，600 dpi  # English: Save the chart as
