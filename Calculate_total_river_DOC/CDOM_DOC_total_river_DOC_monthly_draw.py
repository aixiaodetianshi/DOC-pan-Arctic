...
# 转换 year_month 为 datetime 类型，并计算年份的小数形式  # English: Convert
...
fig, ax = plt.subplots(figsize=(18.5/2.54, 4/2.54))  # 转换为厘米  # English: Convert to centimeters
...
# 绘制平均值水平线  # English: Draw the average horizontal line
...
ax.set_xticks(data['year_decimal'][::6])  # 每年一个刻度  # English: One scale per year
