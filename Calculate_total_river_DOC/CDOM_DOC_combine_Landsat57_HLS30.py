...
for filename in os.listdir(output_folder):
    ...
    # 初始化用于合并的DataFrame列表  # English: Initialize the merged
    df_Landsat5 = []
    df_Landsat7 = []
    df_HLSL30 = []
    df_HLSS30 = []
    ...
    # 检查文件是否存在  # English: Check if the file exists
    if os.path.isfile(in_folder_Landsat5_filename):
        # 文件存在，打开并读取数据  # English: The file exists
        # 读取Excel文件  # English: Read
        df_Landsat5 = pd.read_csv(in_folder_Landsat5_filename)
    else:
        # 文件不存在，打印提示信息  # English: The file does not exist
    ...
    # 合并所有DataFrame  # English: Merge all
    ...
    # 将合并后的数据写入输出文件  # English: Write the merged data to the output file
