...
output_area_fig = os.path.join(output_dir, "Fig1_catchment_number_piechart.tif")

# 分组定义  # English: Grouping definition
river_Name = ["Ob", "Yenisey", "Lena", "Kolyma", "Yukon", "Mackenzie"]
river_number = [10097, 399, 2356, 2070, 1706, 21792]
...
# 标题  # English: title
ax1.set_title("catchment number(%)", fontsize=6, pad=-160)
