...
# 读取合并后的数据  # English: Read merged data
df = pd.read_excel(input_file)

# 计算均方根误差 (RMSE)  # English: Calculate the root mean square error
rmse = np.sqrt(mean_squared_error(df['DOC'], df['DOC_2']))

# 计算相关系数 (r)  # English: Calculate correlation coefficient
...
# 添加RMSE和相关系数到图表中  # English: Add to
