...
# 限制 Average DOC Total 范围在 0 到 288732
data = data[(data['Average_DOC_Total'] >= 0) & (data['Average_DOC_Total'] <= 288732)]

# 根据最大值和最小值，等间距分为20组
min_value = 0
max_value = 288732
bins = np.linspace(min_value, max_value, 21)  # 生成21个点，共20个区间
...
group_counts = group_counts.reindex(range(20), fill_value=0)  # 为每个组填充0
