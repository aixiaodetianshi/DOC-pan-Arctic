# 读取‪D:\UZH\2024\20240122 Nutrient and Organic Carbon references\river_endpoints_water_surface_info\Kolyma_river_endpoints_WaterInfo.csv文件数据
# 共有变量： system:index； COMID；water_occurrence；.geo 5个，第一行是变量名，
# 现在统计water_occurrence的数值分布情况，将其分为11组，第一组是空值；第二组范围是大于等于0，小于10；
# 第3组范围是大于等于10，小于20；第4组范围是大于等于20，小于30；第5组范围是大于等于30，小于40；
# 第6组范围是大于等于40，小于50；第7组范围是大于等于50，小于60；第8组范围是大于等于60，
# 小于70；第9组范围是大于等于70，小于80；第10组范围是大于等于80，小于90；第11组范围是大于等于90，小于等于100，
# 将分组结果输出以相同的文件名输出到
# 文件夹D:\UZH\2024\20240122 Nutrient and Organic Carbon references\river_endpoints_water_surface_info\water_group_river_points中，
# 第一列是分组范围，第二列是每组的数量。
