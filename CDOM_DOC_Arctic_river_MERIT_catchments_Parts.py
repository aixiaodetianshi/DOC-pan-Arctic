# 将文件夹D:\UZH\2024\20240122 Nutrient and Organic Carbon references\6large_rivers_watersheds\6River_Parts_watrersheds_merge\Ob
# 内的所有shp文件保留所有原有属性，合并为Ob.shp文件，
# 保存在文件夹D:\UZH\2024\20240122 Nutrient and Organic Carbon references\6large_rivers_watersheds\6River_Parts_watrersheds_merge内。
