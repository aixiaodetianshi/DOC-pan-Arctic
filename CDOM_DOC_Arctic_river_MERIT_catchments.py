# 现在有文件夹D:\UZH\2024\20240122 Nutrient and Organic Carbon references\6large_rivers_watersheds\6River_Parts_watrersheds_merge，
# 文件夹内有子文件夹6个，分别为6个北极区域名字， 每个子文件夹内有很多流域shp文件，每个shp文件有属性shape，COMID，unitarea，
# 将这个文件夹内的所有shp文件合并在一个shp文件中，保持原来的属性，
# 将合并得到的shp文件保存在文件夹D:\UZH\2024\20240122 Nutrient and Organic Carbon references\6large_rivers_watersheds\6River_Parts_watrersheds_merge内
# 命名为MERIT_Arctic_catchments.shp

# 以上代码会将指定文件夹内的所有 shapefile 合并为一个 shapefile，并保存到目标路径。请确认以下事项：
