...
output_path = r"D:\UZH\2024\20240122 Nutrient and Organic Carbon references\3_river_mouth_DOC\DOC_update_20250203\Total_DOC_monthly\All_month\Total_monthly_DOC_All_Parts_1990s.tif"
...
data_filtered = data[(data['year'] >= 1990) & (data['year'] <= 1999) & (data['month'].isin(range(5, 11)))]
...
ax.set_xlim(pd.to_datetime('1990-01'), pd.to_datetime('1999-12'))
