...
# 绘图
fig, ax = plt.subplots(figsize=(5/2.54, 2.5/2.54), dpi=600)  # 大小为 6cm x 4cm
...
# 设置 x轴 位于 y=0
ax.spines['bottom'].set_position(('data', 0))  # x轴穿过 y=0
ax.spines['bottom'].set_visible(True)          # 显示底部 spine
