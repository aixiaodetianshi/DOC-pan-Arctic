...
target_col = 'Average_Total_DOC_Area_Unit'
df = df.dropna(subset=[target_col])

drop_cols = ['Average_Total_DOC', 'Average_Total_DOC_1', 'Annual_Increase_Rate_1', 'Annual_Increase_Rate_DOC_Area_Unit', 'Average_Total_DOC_Uncertainty', 'center_lon', 'area_km2', 'perimeter', 'COMID', 'Annual_Increase_Rate', 'Intercept', 'R_Value', 'P_Value', 'Std_Err', 'Num_same_COMID', ]
...
output_path = r"D:\UZH\2024\20240122 Nutrient and Organic Carbon references\3_river_mouth_DOC\DOC_update_20250203\Total_DOC_average\Unit_Top20_Feature_Importance.tif"
