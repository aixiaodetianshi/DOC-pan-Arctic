...
df = df[(df['area_km2'] >= 100000)].copy()

drop_cols = ['area_km2', 'perimeter', 'Average_Total_DOC', 'Average_Total_DOC_Area_Unit', 'Average_Total_DOC_1', 'Annual_Increase_Rate_1', 'Average_Total_DOC_Uncertainty', 'center_lon', 'COMID', 'Annual_Increase_Rate', 'Intercept', 'R_Value', 'P_Value', 'Std_Err', 'Num_same_COMID', ]
...
result_df = result_df.sort_values(by='RandomForest_Importance', ascending=False)  # 最重要的在上面
...
# ========== Step 8: 保存图像 ==========
output_path = r"D:\UZH\2024\20240122 Nutrient and Organic Carbon references\3_river_mouth_DOC\DOC_update_20250203\Total_DOC_increase_rate\Unit_positive_Top20_Feature_Importance_Class5.tif"
