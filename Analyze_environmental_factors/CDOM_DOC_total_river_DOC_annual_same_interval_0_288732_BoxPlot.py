...
# 限制 Average DOC Total 范围在 0 到 288732  # English: limit
data = data[(data['Average_DOC_Total'] >= 0) & (data['Average_DOC_Total'] <= 288732)]

# 根据最大值和最小值，等间距分为20组  # English: According to maximum and minimum values
min_value = 0
max_value = 288732
bins = np.linspace(min_value, max_value, 21)  # 生成21个点，共20个区间  # English: generate

# 将数据分为20个组  # English: Divide the data into
...
group_counts = group_counts.reindex(range(20), fill_value=0)  # 为每个组填充0  # English: Fill for each group
...
plt.title('Number of Rivers in Each Equal Interval Average DOC Total Group (0-288732)', fontsize=20, fontweight='bold')
...
output_path = r"D:\UZH\2024\20240122 Nutrient and Organic Carbon references\DOC\average_Total_DOC\Equal_Interval_Average_DOC_Total_Group_288732_Counts_20.tif"
